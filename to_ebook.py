...
from ebook_prompts import (
    pick_manga_folder, pick_format, pick_split, pick_grayscale, pick_dpi,
    pick_kindle_settings,
    SPLIT_THRESHOLD, KINDLE_W, KINDLE_H, KINDLE_PRESETS, KINDLE_DEFAULT_MARGIN,
)
    ...
    for vol_idx, chunk in enumerate(chunks, 1):
        ...
        if fmt == 'pdf':
            ...
            epub_path = build_epub(
                manga_dir, dpi=dpi, grayscale=grayscale,
